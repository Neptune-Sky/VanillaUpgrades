...
namespace VanillaUpgrades
{
    internal static class HoverHandler
    {
        ...
        public static void TwrTo1()
        {
            ...
            var localGravity =
                (float)WorldManager.currentRocket.location.planet.Value.GetGravity(WorldManager.currentRocket.location
                    .position.Value.magnitude);
            ...
            foreach (EngineModule engineModule in WorldManager.currentRocket.partHolder.GetModules<EngineModule>())
            {
